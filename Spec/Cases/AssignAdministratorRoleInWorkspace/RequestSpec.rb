...
describe 'request model for AssignAdministratorRoleInWorkspace' do
  it 'returns data object for the context' do
    ...
    data        = AssignAdministratorRoleInWorkspace::Request.new(arguments)
                    .prepare
...
end # request model for AssignAdministratorRoleInWorkspace
