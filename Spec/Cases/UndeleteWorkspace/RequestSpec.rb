...
require 'json'
require 'redis'
require_relative '../../../Cases/UndeleteWorkspace/Request'
...
describe 'request model for UndeleteWorkspace' do
  it 'returns data object for the context' do
    ...
    data        = UndeleteWorkspace::Request.new(payload, actor, entity).prepare
...
end # request model for UndeleteWorkspace
